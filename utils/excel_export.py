...
def export_to_excel(os_df: pd.DataFrame, db_df: pd.DataFrame,
    ...
    rows = [
        ...
        ("", ""),
        ("Agent 1", "Dynamically fetches ALL OS & DB lifecycle data from the web via Claude AI web search (no hardcoded data)"),
        ...
        ("", ""),
        ("OS Families Covered",
         "Windows 10/11 Client, Windows Server, RHEL, Ubuntu, SLES, Debian, CentOS, Rocky/AlmaLinux, "
         "Oracle Linux, openSUSE, Fedora, macOS, Solaris, AIX, HP-UX, FreeBSD, OpenVMS, Android, iOS"),
        ("DB Products Covered",
